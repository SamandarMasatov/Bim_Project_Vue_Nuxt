      ...
      <div class="pa-10" id="rang">
        ...
        >
          <v-col cols="6" style="padding: 0; height: 550px">
            <div class="img">
              <v-img
                width="100%"
                height="100%"
                :src="`http://api.bimproject.uz/uploads/model/${images[imgId]}`"
              ></v-img>
          ...
          <v-col
            cols="6"
            class="margin-bottom"
            style="background: #007cc7; padding: 0 30px"
          >
            <div
            ...
            <v-btn
              :to="`/${$i18n.locale}/models/pay/${model._id}`"
              outlined
              rounded
              color="white"
        ...
        for (let i = 0; i < models.length; i++) {
          ...
          if (models[i]._id == id) {
            ...
            let fullDate =
              ...
              date[1]
            this.reviews = [
              { title: this.$t('render'), value: this.model.render },
              { title: this.$t('razmer'), value: this.model.razmer + 'mb' },
              { title: this.$t('slinyak'), value: this.model.slug },
